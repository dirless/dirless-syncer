  ...
  describe SyncLoop do
    describe "#run_once" do
      it "completes a full sync cycle on the happy path" do
        stub_happy_path
        SyncLoop.new(SpecHelper.config, identity_store_id: SpecHelper::IDENTITY_STORE_ID, region: SpecHelper::REGION, syncer_id: SpecHelper::SYNCER_ID).run_once # should not raise
      end
      ...
      it "sends provider IDs (not usernames) in the members array" do
        ...
        SyncLoop.new(SpecHelper.config, identity_store_id: SpecHelper::IDENTITY_STORE_ID, region: SpecHelper::REGION, syncer_id: SpecHelper::SYNCER_ID).run_once
      ...
      it "handles a backend sync error gracefully" do
        ...
        SyncLoop.new(SpecHelper.config, identity_store_id: SpecHelper::IDENTITY_STORE_ID, region: SpecHelper::REGION, syncer_id: SpecHelper::SYNCER_ID).run_once # should not raise — errors are logged, not propagated
      end
